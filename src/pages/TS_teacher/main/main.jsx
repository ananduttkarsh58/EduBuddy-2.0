...
const Main = () => {
  const [messages, setMessages] = useState([
    { id: 1, sender: "bot", text: "Hello Teacher?" },
    { id: 2, sender: "user", text: "Hello Student?" },
    ...
    <div className={styles.main}>
      ...
      <div className={styles.chatContainer}>
        {messages.map((m) => (
          ...
          >
            {m.sender === "bot" && <div className={styles.avatarLabel}>Student</div>}
            {m.sender === "user" && <div className={styles.userLabel}>Teacher</div>}

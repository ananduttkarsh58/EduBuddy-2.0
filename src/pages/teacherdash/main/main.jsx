    ...
    <div className={styles.container}>
      ...
      <aside className={styles.sidebar}>
        <div className={styles.header}>
          ...
          <img src="https://i.ibb.co/4wBybCZD/kiit-logo.jpg" alt="KIIT Logo" className={styles.logo}/>
      ...
      <main className={styles.main}>
        ...
        <section className={styles.quickActions}>
          ...
          <div className={styles.actionButtons}>
            <button className={styles.primaryButton}>Upload Notes</button>
          ...
          <div className={styles.activityList}>
            <div className={styles.activityItem}>
              ...
              <div className={styles.activityContent}>
                ...
                <p className={styles.activityDescription}>Uploaded notes for Calculus 101</p>
              </div>
            </div>
            ...
            <div className={styles.activityItem}>
              ...
              <div className={styles.activityContent}>
                ...
                <p className={styles.activityDescription}>New message from student in Physics 202</p>
              </div>
            </div>
            ...
            <div className={styles.activityItem}>
              ...
              <div className={styles.activityContent}>
                ...
                <p className={styles.activityDescription}>Updated course materials for Chemistry 301</p>
              </div>
            </div>
          </div>
        </section>
